                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex justify-center mb-4">
                            <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 text-sm">
                                ...
                                <span className="text-white font-medium">TOURNAMENT BEGINS IN 10 DAYS</span>
                            </div>
                        </div>
                        ...
                        <h1 className="text-7xl md:text-8xl font-black mb-4 tracking-tight leading-none">
                            ...
                            <span className="relative">
                                ...
                                <span className="absolute -top-6 -right-12 bg-white text-[#0A2472] text-sm px-3 py-1 rounded-full font-bold rotate-12 shadow-lg">
                                    2026
                                </span>
                            </span>
                        </h1>
                        
                        <p className="text-xl md:text-2xl mb-6 text-blue-100 flex items-center justify-center gap-4 flex-wrap">
                            <span className="flex items-center gap-2 bg-white/5 px-4 py-2 rounded-full">
                        ...
                        {/* Prize Pool Badge */}
                        <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-8 py-4 mb-8">
                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
                                <i className="fa-solid fa-trophy text-[#0A2472] text-xl"></i>
                            </div>
                            <div>
                                <span className="text-3xl font-bold text-white">₹4,00,000</span>
                                <span className="text-sm ml-2 text-blue-200">Prize Pool</span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-4 justify-center">
                            <button
                                onClick={() => dispatch(toggleRegisterPopup())}
                                className="group relative bg-white text-[#0A2472] px-10 py-4 rounded-xl font-bold text-xl shadow-2xl hover:shadow-white/30 transform hover:scale-105 transition-all duration-300 overflow-hidden"
                            >
                                <span className="relative z-10 flex items-center gap-2">
                                    <i className="fa-solid fa-cricket"></i>
                                    REGISTER NOW
                                ...
                                <div className="absolute inset-0 bg-[#F1F5F9] opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            </button>
                            ...
                            <button
                                onClick={() => navigate("/login")}
                                className="group relative bg-gradient-to-r from-[#1E293B] to-[#0A2472] text-white px-10 py-4 rounded-xl font-bold text-xl shadow-2xl hover:shadow-[#0A2472]/30 transform hover:scale-105 transition-all duration-300 overflow-hidden"
                            >
                                <span className="relative z-10 flex items-center gap-2">
                                    <i className="fa-solid fa-user-shield"></i>
                                    ADMIN LOGIN
                        ...
                        <div className="mt-12 bg-white/5 backdrop-blur-sm rounded-xl py-3 px-6 border border-white/10 max-w-3xl mx-auto">
                            <div className="flex items-center justify-between text-sm overflow-hidden">
                                <div className="flex items-center gap-4 animate-marquee whitespace-nowrap">
                                    <span className="flex items-center gap-2"><span className="w-2 h-2 bg-white rounded-full"></span> <span className="text-blue-100">Mumbai Strikers vs Pune Warriors - Today 7:30 PM</span></span>
                                    <span className="flex items-center gap-2"><span className="w-2 h-2 bg-white rounded-full"></span> <span className="text-blue-100">Delhi Kings vs Chennai Smashers - Tomorrow 4:00 PM</span></span>
                                    <span className="flex items-center gap-2"><span className="w-2 h-2 bg-white rounded-full"></span> <span className="text-blue-100">Kolkata Tigers vs Bangalore Bulls - 15th March</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        >
            ...
            <section className="py-24 px-6 bg-white" data-animate="teams">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-[#0A2472] text-lg">16 Teams battling for glory</p>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            { name: 'Mumbai Strikers', captain: 'Rohit S.', color: 'from-[#0A2472] to-[#1E293B]', icon: '⚡', bg: 'bg-[#F1F5F9]' },
                            { name: 'Pune Warriors', captain: 'Virat K.', color: 'from-[#0A2472] to-[#1E293B]', icon: '🛡️', bg: 'bg-[#F8FAFC]' },
                            { name: 'Delhi Kings', captain: 'Rishabh P.', color: 'from-[#0A2472] to-[#1E293B]', icon: '👑', bg: 'bg-[#F1F5F9]' },
                            { name: 'Chennai Smashers', captain: 'MS Dhoni', color: 'from-[#0A2472] to-[#1E293B]', icon: '🔥', bg: 'bg-[#F8FAFC]' },
                            { name: 'Kolkata Tigers', captain: 'Andre R.', color: 'from-[#0A2472] to-[#1E293B]', icon: '🐯', bg: 'bg-[#F1F5F9]' },
                            { name: 'Bangalore Bulls', captain: 'Faf D.', color: 'from-[#0A2472] to-[#1E293B]', icon: '🐂', bg: 'bg-[#F8FAFC]' },
                            { name: 'Lucknow Lions', captain: 'KL Rahul', color: 'from-[#0A2472] to-[#1E293B]', icon: '🦁', bg: 'bg-[#F1F5F9]' },
                            { name: 'Hyderabad Hawks', captain: 'Pat C.', color: 'from-[#0A2472] to-[#1E293B]', icon: '🦅', bg: 'bg-[#F8FAFC]' },
                        ].map((team, i) => (
                            <div key={i} className="group relative">
                                <div className={`absolute inset-0 bg-gradient-to-br ${team.color} rounded-xl blur-lg opacity-0 group-hover:opacity-20 transition-opacity`}></div>
                                <div className={`relative ${team.bg} rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-[#E2E8F0]`}>
                                    <div className="text-3xl mb-3">{team.icon}</div>
                                    <h3 className="font-bold text-base text-[#0A2472]">{team.name}</h3>
                                    <p className="text-xs text-[#1E293B]">Captain: {team.captain}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="relative py-32 px-6 overflow-hidden bg-[#0A2472]">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-white/5 rounded-full blur-[120px] animate-pulse delay-1000"></div>
                    ...
                    <div className="absolute bottom-40 right-40 w-3 h-3 bg-white/30 rounded-full animate-float delay-700"></div>
                    <div className="absolute top-60 right-60 w-2 h-2 bg-white/30 rounded-full animate-float delay-1500"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="text-center mb-20">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 mb-6">
                            ...
                            <span className="text-white text-sm font-medium tracking-wider">PARTNERS & SPONSORS</span>
                        </div>
                        ...
                        {/* Decorative Line */}
                        <div className="flex items-center justify-center gap-3 mb-6">
                            <div className="w-12 h-0.5 bg-gradient-to-r from-transparent via-white to-transparent"></div>
                    ...
                    <div className="relative">
                        {/* Gradient Fades */}
                        <div className="absolute left-0 top-0 w-48 h-full bg-gradient-to-r from-[#0A2472] via-[#0A2472]/80 to-transparent z-20"></div>
                        <div className="absolute right-0 top-0 w-48 h-full bg-gradient-to-l from-[#0A2472] via-[#0A2472]/80 to-transparent z-20"></div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex gap-8 w-max sponsor-scroll-left hover:[animation-play-state:paused]">
                                {[...sponsors, ...sponsors].map((logo, i) => (
                                    ...
                                    >
                                        {/* Card with Glow Effect */}
                                        <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-white/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                        
                                        {/* Main Card */}
                                        <div className="relative w-full h-full bg-gradient-to-br from-[#1E293B] to-[#0A2472] backdrop-blur-sm rounded-2xl border border-white/20 shadow-2xl overflow-hidden group-hover:border-white/40 transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2">
                                            
                                            {/* Inner Glow */}
                                            <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/0 to-white/0 group-hover:from-white/10 group-hover:via-transparent group-hover:to-white/10 transition-all duration-700"></div>
                        ...
                        <div className="flex justify-center gap-3 mt-12">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-blue-200 text-sm">Scrolling</span>
                            </div>
                            <i className="fa-solid fa-arrow-left text-blue-300"></i>
                            <i className="fa-solid fa-arrow-right text-blue-300"></i>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-8 mt-20">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-6 py-3 rounded-full border border-white/10">
                                ...
                                <span className="text-blue-200 text-sm font-medium">{item.text}</span>
                            </div>
                        ))}
                    </div>
                </div>
