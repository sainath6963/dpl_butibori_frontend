...
const FrontPageDpl = () => {
  ...
  // YouTube videos slider data
  const videos = [
    { id: 'dQw4w9WgXcQ', title: 'CCL 2026 - Official Teaser' },
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6" data-animate="hero">
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-4 bg-gradient-to-r from-amber-500/10 to-amber-400/5 backdrop-blur-sm border border-amber-500/20 rounded-2xl px-8 py-4 mb-8">
              ...
              <div>
                <span className="text-3xl font-bold text-amber-400">₹1,00,000</span>
      ...
      <section className="py-24 px-6 bg-slate-50" data-animate="videos">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 text-lg">Watch highlights, interviews & behind the scenes</p>
          </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-white">
              <div className="aspect-video relative">
                <iframe
                  ...
                  src={`https://www.youtube.com/embed/${videos[currentVideo].id}?autoplay=0&mute=1&controls=1&modestbranding=1`}
              ...
              {videos.map((video, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-2 left-2 right-2">
                    <p className="text-white text-xs font-medium line-clamp-1 text-left">{video.title}</p>
                  </div>
                  {currentVideo === index && (
