...
const UserDashboard = () => {
  ...
  // Static demo stats (you can later connect to real API)
  const stats = {
    activeSessions: 5,
  ...
  return (
    <div className="p-6 w-full max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div className="bg-white p-7 rounded-3xl shadow-lg border hover:shadow-2xl hover:scale-[1.03] transition">
      ...
      <div className="mt-12 text-center text-gray-500 text-lg">
        No detailed activity data available yet.
      </div>
    </div>
  );
};
